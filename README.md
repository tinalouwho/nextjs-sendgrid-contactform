...
First, sign up for a free account on SendGrid and Twilio.

Navigate to your dashboard. Verify a Single Sender and authenticate.

Then, select Email API from the left side-bar and follow the integration guide.

Replace the API key in the .env with yours.
